    ...
    <main>
        ...
        <div class="slider-area position-relative ">
            ...
            <div class="hero-shape bounce-animate">
                <img src="{{ asset('assets') }}/img/hero/hero-shape.png" alt="">
            </div>

            <div class="hero-shape2">
                <img src="{{ asset('assets') }}/img/hero/hero-shape2.png" alt="">
            </div>
        </div>
                ...
                <div class="top-job-slider ">
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="{{ asset('assets') }}/img/icon/job-iocn1.svg" alt="">
                        </div>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="{{ asset('assets') }}/img/icon/job-iocn2.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="{{ asset('assets') }}/img/icon/job-iocn3.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="{{ asset('assets') }}/img/icon/job-iocn4.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="single-top-jobs ">
                        <div class="services-ion">
                            <img src="{{ asset('assets') }}/img/icon/job-iocn5.svg" alt="">
                        </div>
                        <div class="services-cap">
                            <h5><a href="#">Design & creatives</a></h5>
                            <p>The automated process starts as soon as your clothes go into.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="{{ asset('assets') }}/img/icon/top-cat1.svg" alt="">
                            </div>
                            <div class="cat-cap">
                                <h5><a href="#">Design & creatives</a></h5>
                                <p>The automated process starts as soon as your clothes go into.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="{{ asset('assets') }}/img/icon/top-cat2.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="{{ asset('assets') }}/img/icon/top-cat3.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="{{ asset('assets') }}/img/icon/top-cat4.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="{{ asset('assets') }}/img/icon/top-cat5.svg" alt="">
                            </div>
                            <div class="cat-cap">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat">
                            <div class="cat-icon">
                                <img src="{{ asset('assets') }}/img/icon/top-cat6.svg" alt="">
                            </div>
                            <div class="cat-cap">
        ...
        <div class="testimonial-area">
            <div class="container">
                <div class="testimonial-wrapper">
                            ...
                            <div class="h1-testimonial-active dot-style">
                                ...
                                <div class="single-testimonial position-relative">
                                    <div class="testimonial-caption">
                                        <img src="{{ asset('assets') }}/img/icon/quotes-sign.png" alt=""
                                            class="quotes-sign">
                    ...
                    <div class="t-shape">
                        <img src="{{ asset('assets') }}/img/gallery/testimonial-shape.png" alt="">
                    </div>
                </div>
            </div>
        </div>
