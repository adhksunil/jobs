                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0">
                        <div class="blog_left_sidebar">
                                ...
                                <article class="blog_item">
                                    <div class="blog_item_img">
                                        <img class="card-img rounded-0"
                                            src="{{ asset('assets') }}/img/blog/single_blog_{{ $blog->id }}.jpg"
                                            alt="">
                                        <a href="#" class="blog_item_date">
                                            {{-- <h3>15</h3> --}}
                                            <p>{{ $blog->created_at->format('M d ') }}</p>
                                        </a>
                                    </div>
                                    <div class="blog_details">
                                        <a class="d-inline-block" href="{{ url('/blog/detail', $blog->id) }}">
                                            <h2 class="blog-head" style="color: #2d2d2d;">{{ $blog->title }}
                                            </h2>
                                        </a>
                                        <p>{!! Str::limit($blog->article_content, 300) !!}</p>
                            ...
                            {{-- <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('assets') }}/img/blog/single_blog_2.jpg"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                            ...
                            {{-- </div>
                                <div class="blog_details">
                                    <a class="d-inline-block" href="{{ url('/blog/detail') }}">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('assets') }}/img/blog/single_blog_3.jpg"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('assets') }}/img/blog/single_blog_4.jpg"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{ asset('assets') }}/img/blog/single_blog_5.jpg"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder='Search Keyword'
                                                ...
                                                onblur="this.placeholder = 'Search Keyword'"name='keyword'>
